...
Technical Stack:
	...
	Graphical Front-End: Python 3 (Tkinter)
...
GUI Launch
	...
	Opening the compiled executable now launches the graphical interface by default.

	To use the graphical interface run:
		Main.exe

	If the executable is in a different location, you can browse to it from the interface.
